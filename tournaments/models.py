...
class Tournament(models.Model):
    ...
    period = models.CharField(max_length=100, blank=True, null=True, verbose_name='Сроки проведения (произвольный текст)')
    date = models.DateField(default='2000-01-01', blank=True, verbose_name='Дата турнира (определяет сортировку)')
